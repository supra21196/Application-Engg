...
public class ViewJpanel extends javax.swing.JPanel {
    ...
    public ViewJpanel(Driverslic product) {
        ...
        try {
            ImageIcon i = new ImageIcon(ImageIO.read(new File(product.getFileName())));
            BufferedImage img = ImageIO.read(new File(product.getFileName()));
            Image ig = img.getScaledInstance(156, 201,Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(PictureLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
                .addGap(16, 16, 16))
        );
